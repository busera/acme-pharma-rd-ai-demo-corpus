...
| File | Source basis | Audit-planning use |
|---|---|---|
...
| `06_third_party_risk_assessment.md` | Third Party Risk Assessment Summary | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `07_legal_ip_review_questions.md` | Legal and IP Review Questions for R&D AI | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `08_cloud_architecture_overview.md` | Cloud Architecture Overview for R&D AI Sandbox | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `09_data_flow_description.md` | 'Data Flow Description: R&D AI Pilot' | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `10_model_development_lifecycle_sop.md` | Model Development Lifecycle SOP for R&D AI | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `11_model_card_experiment_design_assistant.md` | 'Model Card: Experiment Design Assistant' | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `12_validation_plan.md` | Validation Plan for R&D AI Pilot | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `13_risk_register_extract.md` | R&D AI Risk Register Extract | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `14_research_integrity_review_minutes.md` | Research Integrity Review Minutes | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `15_acceptable_use_policy.md` | Acceptable Use Policy for AI in R&D | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `16_training_material_outline.md` | 'Training Material Outline: Responsible AI Use in R&D' | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `17_access_control_matrix.md` | Access Control Matrix for R&D AI Sandbox | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `18_logging_monitoring_summary.md` | Logging and Monitoring Summary | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `19_incident_response_playbook.md` | 'Incident Response Playbook: AI Data Leakage in R&D' | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `20_change_management_log.md` | Change Management Log for R&D AI Pilot | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `21_model_output_review_template.md` | Model Output Review Template | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `22_research_portfolio_board_notes.md` | Research Portfolio Board Notes on AI Pilot | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `23_procurement_intake_questionnaire.md` | Procurement Intake Questionnaire for AI Vendors | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
| `24_data_retention_deletion_standard.md` | Data Retention and Deletion Standard for AI Pilots | Internal-looking planning evidence for ACME Pharma R&D AI audit scope |
